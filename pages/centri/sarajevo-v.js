...
import { SarajevoVGallery } from '../../Components/centri/SarajevoVGallery';
import checkGreen from '../../public/images/centri/check.png';
import greenSphere from '../../public/images/centri/sphere.png';
import CentarPopup from '../../Components/popups/CentarPopup';
...
const SarajevoV = () => {
    return (
        <>
            ...
            <section id="centriSarajevoV" className="centriSarajevoV section">
                <div className="container">
                    <div className="columns">
                        <div className="column is-4">
                            <div className="titleTopCentri">
                                <img src={pointImg} alt="" />
                                <h1 className="title singleCentarTitle">Centar - Sarajevo Centar</h1>
                            </div>
                            <div className="infoCentar">
                                ...
                                <p className="cityInfoTitle">Email:</p>
                                    ...
                                    <div className="column is-10">
                                        ...
                                        <p><span
                                        className="cityInfoContent">centar@nomasvello.ba</span></p>
                                    </div>
                                </div>
                            </div>
