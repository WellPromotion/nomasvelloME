...
import sample1 from '../../../public/images/kozmeticki-proizvodi/kozmetikaCiscenje/piling-tijelo/1.png'
...
const NomasvelloPilingZaTijelo = () => {
    return (
            ...
            <section id="featuredProduct" className="featuredProduct section">
                <div className="container">
                    <div className="columns level colsProtivNesavrsenosti">
                        ...
                        <div className="column">
                            <p className='featuredTitle'>NoMasVello piling za tijelo</p>
                            <p className='featuredSubtitle'>Osmišljen je za dubinski, ali nježan tretman eksfolijacije uz korištenje visokokvalitetnih sastojaka.</p>
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div className="column">
                            ...
                            <div className="detailsList">
                                  <img className="greenCheckSpacing" src={turqCheck} alt="" />
                                        ...
                                        <p className="odlikeItem">Prirodno piling djelovanje: prah vulkanske stijene vrši eksfolijaciju koja uklanja mrtve ćelije bez iritacije. Čini kožu glatkom, pobljšava teksturu,a rezultat je meka i sjajna koža.</p>
                                        </div>
                                </div>
                                <div className="detailsList">
                                  <img className="greenCheckSpacing" src={turqCheck} alt="" />
                                        ...
                                        <p className="odlikeItem">Hranjiva i njegujuća svojstva: bogat oleinskom, stearinskom i linolenskom kiselinom, što ga čini idealnim saveznikom u njezi i regeneraciji kože. Ove masne kiseline pomažu da koža bude nježna, elastična i hidrirana.</p>
                                        </div>
                                </div>
                                {/* <div className="detailsList">
                                  <img className="greenCheckSpacing" src={turqCheck} alt="" />
                            ...
                            <div className="listInner">
                                ...
                                <div className="detailsList">
                                  <img className="greenCheckSpacing" src={greenCheck} alt="" />
                                    <div className="singleDetail">
                                    <p className='odlikeTitle'>Emolijentno djelovanje</p>
                                        <p className="odlikeItem">Umiruje kožu, sprečava suhoću i ljuštenje, te pruža ugodan osjećaj i mekoću.</p>
                                        </div>
                                </div>
                                <div className="detailsList">
                                  <img className="greenCheckSpacing" src={greenCheck} alt="" />
                                    <div className="singleDetail">
                                    <p className='odlikeTitle'>Nježna i dubinska eksfolijacija</p>
                                        <p className="odlikeItem">Uklanja mrtve ćelije kože, potiče obnavljanje kože, čini kožu svježom i sjajnom.</p>
                                        </div>
                                </div>
                                <div className="detailsList">
                                  <img className="greenCheckSpacing" src={greenCheck} alt="" />
                                    ...
                                    <p className='odlikeTitle'>Prevencija pojave uraslih dlačica</p>
                                        <p className="odlikeItem">Adekvatna eksfolijacija kože omogućava dlačicama da pravilno rastu, te smanjuje rizik od urastanja dlačica.</p>
                                        </div>
                                </div>
                                <div className="detailsList">
                                  <img className="greenCheckSpacing" src={greenCheck} alt="" />
                                    <div className="singleDetail">
                                        ...
                                        <p className="odlikeItem">Eksfolijacija kože prije i poslije tretmana poboljšava rezultate i povećava učinkovitost NoMasVello tretmana.
</p>
                                        </div>
                                </div>
                            </div>
...
export default NomasvelloPilingZaTijelo;