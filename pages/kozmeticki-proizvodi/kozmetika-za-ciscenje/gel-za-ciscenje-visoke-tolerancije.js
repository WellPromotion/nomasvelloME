...
const GelZaCiscenjeVisokeTolerancije = () => {
    return (
            ...
            <section id="featuredProduct" className="featuredProduct">
                <div className="container">
                    <div className="columns level">
                        ...
                        <div className="column">
                            <p className='featuredTitle'>GEL ZA ČIŠĆENJE VISOKE TOLERANCIJE</p>
                            <p className='featuredSubtitle'>Svakodnevno čišćenje za sve tipove kože, a pogotovo za osjetljivu kožu</p>
                            <p className='featuredText'>Za mladu kožu, kožu sa znacima fotostarenja, ugašenu kožu i kožu sa prvim znacima starenja.</p>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="columns">
                        <div className="column">
                            <div className="titleInner">
                                ...
                                <p className='titleFeatures'>Aktivne supstance koje se nalaze u ovom gelu su:</p>
                            </div>
                            <div className="listInner">
                            <div className="detailsList">
                                  <img className="greenCheckSpacing" src={turqCheck} alt="" />
                                        <div className="singleDetail">
                                            <p className='odlikeTitle'>Zob:</p>
                                        <p className="odlikeItem">Hidratizuje i hrani kožu. Čisti kožu.</p>
                                        </div>
                                </div>
                                <div className="detailsList">
                                  <img className="greenCheckSpacing" src={turqCheck} alt="" />
                            ...
                            <div className="listInner">
                                <div className="detailsList">
                                  <img className="greenCheckSpacing" src={greenCheck} alt="" />
                                        <div className="singleDetail">
                                        <p className="odlikeItem">Čišćenje osjetljive kože obogaćeno ekstraktima zobi i mimoze, kao i aloe verom.</p>
                                        </div>
                                </div>
                                <div className="detailsList">
                                  <img className="greenCheckSpacing" src={greenCheck} alt="" />
...
export default GelZaCiscenjeVisokeTolerancije;