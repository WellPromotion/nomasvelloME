import styles from '../../../styles/kozmeticki-proizvodi/linija-za-ucvrscivanje/AmpuleZaUcvrscivanje.module.scss';
import Breadcrumbs from 'nextjs-breadcrumbs';
import sample1 from '../../../public/images/kozmeticki-proizvodi/linija-za-ucvrscivanje/ampule-za-ucvrscivanje/ampule-za-ucvrscivanje.png'
            ...
            <section id="featuredProduct" className="featuredProduct section">
                <div className="container">
                    <div className="columns level colsProtivNesavrsenosti">
                        ...
                        <div className="column">
                            <p className='featuredTitle'>AMPULE ZA UČVRŠĆIVANJE</p>
                            <p className='featuredSubtitle'>Trenutačni flash efekat učvršćivanja </p>
                            ...
                            <div className="listInner">
                                <div className="detailsList">
                                  <img className="greenCheckSpacing" src={greenCheck} alt="" />
                                        ...
                                        <p className="odlikeItem">Vodena otopina koja se brzo apsorbuje.</p>
                                        </div>
                                </div>
                                <div className="detailsList">
                                  <img className="greenCheckSpacing" src={greenCheck} alt="" />
                                        <div className="singleDetail">
                                        <p className="odlikeItem">Zahvaljujući DMAE vrši učvršćivanje sa flash efektom.</p>
                                        </div>
                                </div>
                                <div className="detailsList">
                                  <img className="greenCheckSpacing" src={greenCheck} alt="" />
                                        <div className="singleDetail">
                                        <p className="odlikeItem">Sadrži mliječnu kiselinu koja vrši piling efekat, hidrataciju i ujednačava ten kože.</p>
                                        </div>
                                </div>
                                <div className="detailsList">
                                  <img className="greenCheckSpacing" src={greenCheck} alt="" />
                                        <div className="singleDetail">
                                        <p className="odlikeItem">Ublažava bore
i hidratizuje kožu.</p>
                                        </div>
                                </div>
                            </div>
                        </div>
...
<br /><br />
Anti-age tretman sa efektom učvršćivanja. Efekat vidljiv odmah. Namijenjeno zreloj koži.
                                </p>
                            </div>
                        </div>
                    </div>
...
export default AmpuleZaUcvrscivanje;