import styles from '../../../styles/kozmeticki-proizvodi/linija-protiv-nesavrsenosti/KremaProtivNesavrsenosti.module.scss';
import Link from 'next/link';
import Breadcrumbs from 'nextjs-breadcrumbs';
import sample1 from '../../../public/images/kozmeticki-proizvodi/linija-protiv-nesavrsenosti/krema-protiv-nesavrsenosti/krema-protiv-nesavrsenosti-na-kozi.png'
...
const KremaProtivNesavrsenosti = () => {
    return (
            ...
            <section id="featuredProduct" className="featuredProduct section">
                <div className="container">
                    <div className="columns level colsHidrozastitnaEmulzija">
                        ...
                        <div className="column">
                            <p className='featuredTitle'>KREMA PROTIV NESAVRŠENOSTI
NA KOŽI</p>
                            <p className='featuredSubtitle'>Hidratantna nemasna krema za lice. Reguliše proizvodnju masti, uklanja nečistoće i ublažava nesavršenosti na koži.</p>
                        </div>
                    </div>
                </div>
            </section>
                            ...
                            <div className="listInner">
                                <div className="detailsList">
                                  <img className="greenCheckSpacing" src={greenCheck} alt="" />
                                        ...
                                        <p className="odlikeItem">Poboljšava zacjeljivanje.</p>
                                        </div>
                                </div>
                                <div className="detailsList">
                                  <img className="greenCheckSpacing" src={greenCheck} alt="" />
                                        <div className="singleDetail">
                                        <p className="odlikeItem">Hidratizira i umiruje kožu zahvaljujući sadržaju aloe vere i kamilice.</p>
                                        </div>
                                </div>
                                <div className="detailsList">
                                  <img className="greenCheckSpacing" src={greenCheck} alt="" />
                                        <div className="singleDetail">
                                        <p className="odlikeItem">Ima anti-ageing djelovanje.</p>
                                        </div>
                                </div>
                            </div>
                        </div>
                        <div className="column rightColumn">
                            <div className="listInner">
                                <div className="detailsList">
                                  <img className="greenCheckSpacing" src={greenCheck} alt="" />
                                        <div className="singleDetail">
                                        <p className="odlikeItem">Brza apsorpcija i lako nanošenje.</p>
                                        </div>
                                    </div>
                                    <div className="detailsList">
                                  <img className="greenCheckSpacing" src={greenCheck} alt="" />
                                        <div className="singleDetail">
                                        <p className="odlikeItem">Obnavlja i regeneriše kožu. Njena molekula je veća od molekule glikolne kiseline i zbog toga se odlikuje potpunom tolerancijom kod primjene na osjetljivoj koži.</p>
                                        </div>
                                    </div>
                            </div>
                        </div>
                    ...
                    <div className="columns">
                        <div className="column has-text-centered">
                            ...
                            <div className="textPart">
                                ...
                                Nanositi ujutro i navečer na čistu i suhu kožu.
                                </p>
                            </div>
                        </div>
                    </div>
...
export default KremaProtivNesavrsenosti;