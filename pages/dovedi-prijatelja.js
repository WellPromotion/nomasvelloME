                ...
                <div className="container">
                    ...
                    <div className="columns botSteps">
                        ...
                        <div className="singleItem">
                                ...
                                <p className="defaultText">Svaki prijatelj koji dođe mora postati No+Vello klijent kupovinom jedne sesije laserske epilacije ili epilacije IPL tehnologijom od 55 KM. Tako automatski dobija kupon za popust od 50% za drugu sesiju.</p>
                            </div>
                        </div>
                        <div className="column">
                        <div className="singleItem">
